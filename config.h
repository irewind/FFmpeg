...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --target-os=darwin --arch=arm --as='/usr/local/bin/gas-preprocessor.pl ${CC}' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS7.1.sdk --extra-cflags='${CFLAGS}' --extra-ldflags='${LDFLAGS}' --cpu=cortex-a9 --disable-asm --disable-doc --disable-ffserver --disable-programs --enable-cross-compile --disable-bzlib --disable-gpl --disable-shared --enable-static --disable-mmx --enable-network --enable-protocol=tcp --enable-demuxer=rtsp --enable-muxer=h264 --enable-muxer=mp4 --enable-muxer=mov --enable-encoder=mpeg4 --enable-decoder=mpeg4 --enable-decoder=h264 --disable-debug --enable-protocol=file --disable-neon --disable-ffmpeg --disable-ffplay --enable-pic --prefix=/Users/wf/Work/code/irewind-ios/External/ffmpeg4ios/bin/armv7s"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/Users/wf/Work/code/irewind-ios/External/ffmpeg4ios/bin/armv7s/share/ffmpeg"
#define AVCONV_DATADIR "/Users/wf/Work/code/irewind-ios/External/ffmpeg4ios/bin/armv7s/share/ffmpeg"
